 ...
 * @author arij_
 */
public class DeleteEleveForm extends Form {
    public DeleteEleveForm(Form previous){
        
        setTitle("Delete a new task");
        setLayout(BoxLayout.y());
        
        TextField tfId = new TextField("","Id");
          Button btnValider = new Button("Delte task");
        //////////////////////////////////////////////////////////////////
    ...
    dlg.add(blueLabel);
    TextArea ta = new TextArea("Vous voulez vraiment Supprimer cette Eleve");
...
btnValider.addActionListener(e -> {
    ...
    ToastBar.Status status = ToastBar.getInstance().createStatus();
            status.setMessage("Eleve Supprimer ...");
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    try {
                       ...
                       Eleve t = new Eleve(Integer.parseInt(tfId.getText()));
                       
                        if( ServiceEleve.getInstance().DeleteEleveForm(t))
                            Dialog.show("Success","Insciption supprimé avec succes",new Command("OK"));
                        else
