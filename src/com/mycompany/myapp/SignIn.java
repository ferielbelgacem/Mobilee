...
static {
   ...
   private int calculateDPI() {
    ...
    public void init(Object context) {
        try {
            ...
            // than as files so we can use the MultiImage functionality
             ...
             theme = Resources.openLayered("/theme1");
    ...
    public void start() {
        ...
        loginForm = new Form("Bienvenue sur EASEYCHOOL");
  ...
  loginForm.getToolbar().addMaterialCommandToSideMenu("Easychool",FontImage.MATERIAL_IMPORTANT_DEVICES, e -> {});
   ...
   loginForm.getToolbar().addMaterialCommandToSideMenu("Exit", FontImage.MATERIAL_EXIT_TO_APP, e -> {Display.getInstance().exitApplication();}); 
      ...
      loginForm.getToolbar().addMaterialCommandToSideMenu("Pocker",FontImage.MATERIAL_GAMES, ev->{
       ...
       if(current != null){
        ...
        Button signIn = new Button("Veuillez visiter notre Espace ");
