...
public abstract class StateMachineBasee extends UIBuilder {
...
**/
    ...
    public StateMachineBasee(Resources res, String resPath, boolean loadTheme) {
    ...
    public StateMachineBasee() {
    }

    public StateMachineBasee(String resPath) {
        this(null, resPath, true);
    }

    public StateMachineBasee(Resources res) {
        this(res, null, true);
    }

    public StateMachineBasee(String resPath, boolean loadTheme) {
        this(null, resPath, loadTheme);
    }

    public StateMachineBasee(Resources res, boolean loadTheme) {
