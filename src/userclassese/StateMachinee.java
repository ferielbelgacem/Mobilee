...
import generatede.StateMachineBasee;
 ...
 */
public class StateMachinee extends StateMachineBasee {
    ...
    public StateMachinee(String resFile) {
        super(resFile);
    ...
    protected void initVars() {
        TestNativee n = (TestNativee)NativeLookup.create(TestNativee.class);
